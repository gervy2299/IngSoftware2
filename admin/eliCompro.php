...
<head>
	...
	<title>ELIMINACIÓN DE COMPROBANTE</title>
...
<body>
	<h1>Eliminar Comprobante</h1>
	   <a href="sales.php"><span class="icon-home"></span></a>
	<form action="eliCompro.php" method="POST">
		<input type="text" name="id_Comprobante" placeholder="INGRESE ID"><br>
...
mysqli_query($conexion, "DELETE from comprobante where id_Comprobante='$id_Comprobante'") or die ("Error al eliminar los datos");
