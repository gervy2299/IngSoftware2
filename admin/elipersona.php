...
<form action="elipersona.php" method="POST">
		<input type="text" name="id_Persona" placeholder="Ingresar ID"><br>

    <input type="submit" onclick="eventoClick();" value="ELIMINAR REGISTRO" name="btnEliminar"><br>
    <input type="submit" id="recar" value="Verificar" name="verieli"><br>
...
mysqli_query($conexion, "DELETE from persona where id_Persona='$id_Persona'") or die ("Error al eliminar los datos");
