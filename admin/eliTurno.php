...
<form action="eliTurno.php" method="POST">
		<input type="text" name="id_Turno" placeholder="Ingresar ID"><br>
...
mysqli_query($conexion, "DELETE from turno where id_Turno='$id_Turno'") or die ("Error al eliminar los datos");
