...
<form action="eliboleta.php" method="POST">
		<input type="text" name="id_Boleta" placeholder="Ingresar ID"><br>
...
mysqli_query($conexion, "DELETE from boleta where id_Boleta='$id_Boleta'") or die ("Error al eliminar los datos");
