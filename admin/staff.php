...
<?php
   ...
   $sql ="SELECT * FROM datosempleado $where";
...
<span class="icon-dolar"></span>
 ...
 <div id="content-wrapper">
        <div class="container-fluid">
          <!-- Page Content -->
          <h1>Administración de Empleados</h1> <!--TITULOOOOOOOO-->
          <hr>
          <div class="row">
            <div >
              <div >
                <a href="../admin/addstaff.php" class="btn">AGREGAR EMPLEADO</a>
<a href="../admin/ediempleado.php" class="btn">ACTUALIZAR EMPLEADO</a>
<a href="../admin/eliempleado.php" class="btn">ELIMINAR EMPLEADO</a>  <br> <br>
 <a href="../reporte_empleado.php" class="btn btn-danger">PDF</a>
<a href="../dexcel_empleado.php" class="btn btn-success">XLS</a> <br> <br> 



<div class="row">
            <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
              <b>...Categoria: </b><input type="text" id="campo" name="campo"/>
