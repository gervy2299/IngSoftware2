...
<form action="elicliente.php" method="POST">
		<input type="text" name="idcliente" placeholder="Ingresar ID"><br>
		<input type="submit" onclick="eventoClick();" value="ELIMINAR REGISTRO" name="btnEliminar"><br>
		  <input id="recar" type="submit" value="Verificar" name="elicli"><br>
 <?php 
...
mysqli_query($conexion, "DELETE from cliente where idcliente='$idcliente'") or die ("Error al eliminar los datos");
