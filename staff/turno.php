 ...
 <!------------------ Sidebar ------------------->
      ...
      <div id="content-wrapper">
        <div class="container-fluid">
          <!-- Breadcrumbs-->
          <!-- Page Content -->
          <h1 class="main__title">Turno de Empleado</h1>
          <hr>
          <div class="row">
            <div class="">
              <div class="">
                <div class="card-body" id="tabla1">
...
<tr>
    ...
    <td class="encabezado"><b>Mesa</b></td>
    <td class="encabezado"><b>Delivery</b></td>
...
<td class="table-item"><?php echo $mostrar ['Cod_Mesa']?></td>
  <td class="table-item"><?php echo $mostrar ['Cod_Delivery']?></td>
  <td class="table-item"><?php echo $mostrar ['Categoria']?></td>
   <td class="table-item"><?php echo $mostrar ['idEmpleado']?></td>
    <td class="table-item"><?php echo $mostrar ['persona']?></td>
</tr>
<?php
}
?>
